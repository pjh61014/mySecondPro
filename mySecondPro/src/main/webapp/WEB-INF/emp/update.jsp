...
<form name="form1" method="post" 
					action="mybatismember_update.do">
<table align="center" cellpadding="0" cellspacing="0" width="479">
    ...
    <tr>
        ...
        <td width="359">
            ...
            value="<%=userInfo.getId() %>" size="6" readonly><%=userInfo.getId() %></code></p>
        </td>
    </tr>
   <tr>
        <td width="104">
        ...
        <td width="359">
            ...
            value="<%= userInfo.getPass()%>" size="8"></code></p>
        </td>
    </tr>
    <tr>
        <td width="104">
        ...
        <td width="359">
            <p><code><input type="hidden" name="name" 
            value="<%=userInfo.getName() %>" size="6" readonly><%=userInfo.getName() %></code></p>
        </td>
    </tr>
    <tr>
        <td width="104">
        ...
        <td width="359">
            ...
            value="<%= userInfo.getAddr()%>" size="10"></code></p>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td width="359">
            <p><code><input type="text" name="grade"  
            value="<%= userInfo.getGrade()%>" size="6"></code></p>
        </td>
    </tr>
